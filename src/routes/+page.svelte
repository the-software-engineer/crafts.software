...
<main class="min-h-[calc(100vh-4px)] flex items-center justify-center px-6">
  <div class="text-center max-w-md">
    ...
    <p class="mt-3 text-lg text-gray-500">The Software Engineer Ltd.</p>

    <div class="mt-10 flex flex-col gap-3 sm:flex-row sm:justify-center">
      <a
        href="https://gregory.sh"
        class="inline-flex items-center justify-center gap-2 rounded-lg bg-gray-900 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-gray-700"
      >
        <svg
          class="h-4 w-4"
          viewBox="0 0 24 24"
